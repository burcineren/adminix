...
const CODE_EXAMPLE = `import { Adminix } from 'adminix';
...
const FEATURES = [
    {
        icon: Zap,
        title: "Zero Config",
        description: "Point to any REST endpoint. Adminix infers the schema and renders a full CRUD interface.",
            ...
            <section className="relative flex flex-col items-center justify-center text-center px-6 pt-24 pb-20 overflow-hidden">
                ...
                <div className="relative z-10 max-w-3xl mx-auto">
                    ...
                    <p className="text-xl text-[hsl(var(--muted-foreground))] max-w-2xl mx-auto mb-10 leading-relaxed font-medium">
                        Adminix turns any REST API into a production-ready management dashboard instantly. 
            ...
            <section className="max-w-xl mx-auto px-6 mb-20">
                <Card className="flex items-center justify-between p-4 bg-[hsl(var(--card))] border-[hsl(var(--border))]">
                    <div className="flex items-center gap-3">
                        ...
                        <code className="text-sm font-mono text-[hsl(var(--foreground))]">npm install adminix</code>
                    </div>
                    <Button
                        variant="ghost"
                        size="sm"
                        className="text-[10px] font-bold uppercase tracking-wider"
                        onClick={() => navigator.clipboard.writeText("npm install adminix")}
                    >
                        Copy
                    </Button>
                </Card>
            ...
            <section className="max-w-5xl mx-auto px-6 mb-24">
                <div className="text-center mb-12">
                    ...
                    <p className="text-[hsl(var(--muted-foreground))] max-w-lg mx-auto">
                        Adminix handles the repetitive stuff so you can focus on what makes your product unique.
                    </p>
                </div>
                ...
                <Card className="p-10 text-center bg-linear-to-br from-[hsl(var(--primary)/0.05)] to-[hsl(var(--card))] border-[hsl(var(--primary)/0.15)]">
                    ...
                    <div className="flex items-center justify-center gap-3">
                        ...
                        <Button
                            ...
                            onClick={() => window.open("https://github.com/burcineren/adminix", "_blank")}
                        >
            ...
            <footer className="border-t border-[hsl(var(--border))] py-8 px-6">
                <div className="max-w-5xl mx-auto flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-6 text-xs text-[hsl(var(--muted-foreground))]">
                        ...
                        <a href="https://github.com/burcineren/adminix" target="_blank" rel="noopener noreferrer" className="hover:text-[hsl(var(--foreground))] transition-colors">GitHub</a>
