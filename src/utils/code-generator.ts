 ...
 * configured with ZeroAdmin and the provided resources.
 */
export class CodeGenerator {
  ...
  static generateConfigCode(resources: ResourceDefinition[]): string {
    ...
    return `
import { ResourceDefinition } from 'zeroadmin';

/**
 * ZeroAdmin Resource Configuration
...
/**
 * Standard ZeroAdmin Entry Point
 */
...
`;
   ...
   */
  static generatePackageJson(projectName: string = "zeroadmin-project"): string {
...
This project was generated by **ZeroAdmin**.
...
`;
  ...
  /**
   * Generates a single-file API layer that mirrors the ZeroAdmin core behavior
...
/**
 * Auto-generated API hooks for ZeroAdmin resources.
