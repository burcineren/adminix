 ...
 * configured with Adminix and the provided resources.
 */
export class CodeGenerator {
  ...
  static generateConfigCode(resources: ResourceDefinition[]): string {
    ...
    return `
import { ResourceDefinition } from 'adminix';

/**
 * Adminix Resource Configuration
...
`;
   ...
   */
  static generatePackageJson(projectName: string = "adminix-project"): string {
...
This project was generated by **Adminix**.
...
`;
  ...
  /**
   * Generates a single-file API layer that mirrors the Adminix core behavior
...
/**
 * Auto-generated API hooks for Adminix resources.
